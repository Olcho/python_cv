...
image_names=['kite.jpg','horses.jpg','person.jpg']
imgs=[]
...
result=cv.hconcat(imgs)

cv.imshow("Object detection by YOLO v.3",result)
cv.imwrite('practice11_1_result.jpg',result)
